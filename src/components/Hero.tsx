    ...
    <section className="h-screen flex flex-col items-center justify-center text-center relative overflow-hidden">
      <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-8 mb-6">
        <motion.img
          src={hero1}
          alt="Memory 1"
          className="w-28 h-40 md:w-32 md:h-32 rounded-2xl object-cover border-4 border-cyan-400 shadow-[0_0_20px_rgba(0,229,255,0.5)] rotate-[-6deg]"
          animate={{ y: [0, -10, 0] }}
        ...
        <motion.img
          src={hero2}
          alt="Memory 2"
          className="w-28 h-40 md:w-32 md:h-32 rounded-2xl object-cover border-4 border-purple-500 shadow-[0_0_20px_rgba(168,85,247,0.5)] rotate-[6deg]"
          animate={{ y: [0, -10, 0] }}
